...
export const layoutRoutes: Routes = [
  {
    path: '',
    loadComponent: () =>
      import('@app/layout/layout.component').then((c) => c.LayoutComponent),
    children: [
      { path: '', redirectTo: '/client', pathMatch: 'full' },
      {
        path: 'product',
        loadChildren: () =>
          import('@feat/product/product.routes').then((r) => r.ProductRoutes),
      },
      {
        path: 'client',
        loadChildren: () =>
      ...
      },
      {
        path: 'sell',
        loadChildren: () =>
          import('@sell/sell.routes').then((r) => r.SellRoutes),
      },
      {
        path: 'mockdata',
        resolve: {
        ...
        loadComponent: () =>
          import('@shared/mockdata/mockdata.component').then(
            (c) => c.MockdataComponent,
          ),
      },
      {
        path: 'not-found',
