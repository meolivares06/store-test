 ...
 */
export class HttpResponseBodyFormatError extends Error {
  constructor() {
...
export const serverErrorInterceptor: HttpInterceptorFn = (req, next) => {
  // Inject the current service for displaying error notifications.
  ...
  return next(req).pipe(
    tap((httpEvent) => {
      ...
      if (checkInvalid200Response(httpEvent)) {
        ...
        messageService.add({severity: 'warning', summary: 'Info', detail: 'An internal error has occurred. Please try again later.', life: 3000})
